export const ch = {
	...
	"overview-2": {
		...
		text2: "時間分析以月為單位，統計掏空案件數量以及其他各項成因數值進行分析。若相關性接近中度相關或模型成因重要性前五名，並與機關討論確認後則認定為潛在成因。",
		...
		text4: "空間分析以「發生過的道路維修案件」為基礎，分析報案地點具備哪些特質較有機率屬於掏空案件。若掏空案件影響占比大於非掏空案件，並與機關討論確認後則認定為潛在成因。相關潛在成因提供權責機關作為預防或後續改善參考。",
