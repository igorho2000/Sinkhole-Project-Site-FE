export const ch = {
	...
	"space-2": {
		...
		text3: "結果顯示，多數掏空案件位於離中心線較近的路中心，而非預期的路肩，因此可初步排除側溝施工介面的工法問題。",
		text4: "從建築、道路尺度再拉遠，大範圍的土壤液化潛勢是否也會有影響呢？",
		"captiontitle5-1": "位置比值計算方式",
		"captiontext5-1": "將案件距路心距離除以一半路寬，計算位置比值。",
	...
	"space-5": {
		...
		text3: "結果顯示，人工標記的掏空案件中，有5.6%受到水系搶修影響。雖然這並非主要原因，但相較於建案占比1%已屬相對較高。因此，實務上應將其納入預防考量。",
