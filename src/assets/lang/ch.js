export const ch = {
	...
	"time-3": {
		...
		"captiontext4-1": "採用中央氣象署歷史氣象資料中臺北測站的月雨量資料作為臺北市雨量代表。",
	...
	"space-1": {
		...
		text2: "結果顯示，標記案件中屬建案影響者比例僅佔 1.3%，顯示建案並非多數掏空案件的成因。",
	...
	"space-2": {
		...
		text2: "觀察位置比值可發現多數掏空案件位於路心附近，而路肩、路面則分居第二、第三。路肩的掏空案件中多為溝體本身遭外力破壞導致，非介面工法影響，因此非掏空成因。",
		text3: "從建築、道路尺度再放大，更大範圍的土壤液化潛勢是否也會造成影響？",
	...
	"space-3": {
		...
		text1: "提到道路塌陷，多數人直覺會想到土壤液化潛勢。土壤液化不僅對建築地基造成危害，路基也可能因此流失。透過數據是否也可得到一樣的證明？",
		text2: "分析發現，高潛勢區域的案件密度達到2.1 件/km²，遠高於中潛勢（1.3 件/km²）和低潛勢（1.3 件/km²）。掏空案件發生頻率確實遠高於中低潛勢區，除了通報時留意巡檢，未來在該地區也可考慮因地制宜調整工法，強化路基或路面支持力。",
		...
		"captiontext4-2": "顏色越深代表土壤液化潛勢越高，共分三級。",
	},
	"space-4": {
		title: "臨河區域",
	...
	"space-5": {
		...
		text2: "結果顯示，人工標記的掏空案件中，有 8.3%受到水系搶修影響。雖然這並非主要原因，但相較於建案占比 1%已屬相對較高，實務上應將其納入預防考量。",
	...
	credits: {
		...
		"team-3": "案件去重＿＿＿＿＿Iima Yu, Wayne Hung",
		"team-4": "技術指導＿＿＿＿＿Iima Yu, Jack Huang",
