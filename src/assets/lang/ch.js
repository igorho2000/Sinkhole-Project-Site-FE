export const ch = {
	...
	"overview-2": {
		...
		text2: "時間分析以月為單位，統計掏空案件數量以及其他各項成因數值進行分析。若相關性接近中度相關或模型成因重要性第一名，則初步認定為潛在成因。",
	...
	"time-3": {
		...
		text2: "根據模型結果，月雨量在特徵重要性排名第二。然而進一步觀察雨量與掏空案件的關係，發現相關性僅低度正相關(0 - 0.3)。可能是單一成因不足以解釋掏空的發生，或者並非單純的雨量越多掏空就會越多，也許會有一個雨量達到多大才會增加掏空的複雜關係。目前工務局新工處針對雨量，設下雨量達 77mm時進行道路巡檢的預防措施，預防掏空災害發生。",
	...
	"time-6": {
		...
		subtitle: "掏空與河川水位有關嗎？",
		text1: "根據過往研究，河川水位的高低會影響河川周遭地區的地下水位。而地下水位若改變，亦可能影響道路掏空案件的發生，值得延伸探討。",
	...
	"space-1": {
		...
		text2: "以案件中心出發，若周遭10公尺內有建案，且處於施工期間，則定義該掏空可能與建案施工有關(如右下圖)。經過篩選後，標記案件中與建案有關者比例僅佔 1.3%，顯示建案並非多數掏空案件的成因。部分掏空案件中亦有側溝破損、局部路面損壞導致的狀況，並非都因建案導致。",
