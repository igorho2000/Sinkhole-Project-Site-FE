export const ch = {
	...
	home: {
		...
		quotetitle: "道路下方就像海洋",
		quotesubtitle: "「表面看起來沒變，但底下的變化卻遠比想像的還大的多。」新工處指出，過往一線人員發現有些路面修整完畢當下看似平坦，但總會於數個月後再次凹陷的特殊狀況。土壤狀況往往受多種時間、空間因素影響，不僅肉眼不可見，影響也會持續累積，多種因素交互影響，也讓相關研究更加不易。",
		quoteperson: "",
		causetitle: "什麼是天坑？怎麼形成的？",
		causesubtitle:
			"天坑（Sinkhole）原指喀斯特地形的大型岩溶塌陷，多數報導常借用來形容大面積、致災性的塌陷，如道路掏空導致車輛掉入地下、房屋下陷等狀況。形成天坑的主要因素有三：土壤鬆動流失、水流沖刷、路面支持力不足。然而即使因素都具備，塌陷發生的具體時間仍難以預測，使得天坑事件難以預防。"
	},
	sidebar: {
		title: "潛在成因分析",
		subtitle:
			"從時間、空間方面進行成因分析，並透過圖標底色呈現是否為重要成因。",
		cause: "有影響",
		nocause: "無影響",
	},
	sections: {
	...
	"overview-2": {
		...
		text2: "透過描述性統計，比較掏空案件與非掏空案件的數據和分布，並結合質性訪談回饋找出明顯特質。另外在時間序列分析中，借助機器學習和相關矩陣分析，尋找難以察覺的關聯性並確認其相關性。",
	...
	"time-1": {
		...
		text2: "因此，針對有無颱風當年的掏空案件數量，分析時間範圍為2019-2023年。而結果顯示，標記掏空案件的年度數量在颱風當年度確實較多，平均來看比無颱風年度多出近13起案件。顯示颱風對道路掏空案件數量確實有影響。",
	...
	"time-2": {
		...
		text3: "結果顯示，地震數量排名第四，屬於重要特徵且具有一定影響力。而人為因素如地基開挖，也有可能造成土壤鬆動，但多數情況是因擋土壁施作不良而導致掏空塌陷(詳後續空間分析)，不納入地震成因討論。",
