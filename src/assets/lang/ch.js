export const ch = {
	...
	"time-1": {
		...
		text2: "因此，針對有無颱風當年的掏空案件數量，分析的時間範圍設定為2019-2023年。結果顯示，標記掏空案件的年度數量在颱風當年度確實較多，平均來看比無颱風年度多出近13起案件。顯示颱風對道路掏空案件數量確實有影響。",
		text3: "颱風帶來的是短時間的豪大雨，那長時間的降雨呢？",
	...
	"time-2": {
		...
		text3: "結果顯示，地震數量排名第四，屬於重要特徵且具有一定影響力。類似人為因素如地基開挖，也有可能造成土壤鬆動導致塌陷，但多數情況是因側向支撐擋土壁施作所致。",
		text4: "然而，土壤震鬆後短時間內仍不會立即發生掏空，還需要水流沖刷來加劇這一過程。那麼，水的來源有哪些呢？",
		"captiontitle5-1": "2019-2022篩選地震範圍",
		"captiontext5-1": "",
		"captiontitle5-2": "時間成因重要性",
		"captiontext5-2": "",
	},
	"time-3": {
		title: "月雨量",
	...
	"time-5": {
		...
		text3: "如果說河川的水最終會匯聚到大海，那麼潮位是否也會影響道路掏空呢？",
		"captiontitle4-1": "時間成因重要性",
		"captiontext4-1": "",
	...
	"space-1": {
		...
		text2: "結果顯示，標記案件中屬建案影響者比例僅佔1%，顯示建案並非多數掏空案件的成因。",
		text3: "從新聞報導來看，施工疏漏造成的掏空案件數量雖少但危害巨大，應透過落實工地巡檢及通報機制來提早防範。",
		text4: "盤點完建案影響，那鄰基地建築線的側溝呢？掏空案件是否容易發生於側溝與路面交界面的位置？",
		"captiontitle5-1": "建案影響案件篩選方式",
		"captiontext5-1": "若道路維修案件申報時間落於建案開工日期後，且建案位置座落於案件半徑10米內的案件，則定義為建案影響。",
		"captiontitle5-2": "建案影響案件占比",
		"captiontext5-2": "此圖待重新計算",
	},
	"space-2": {
		title: "鋪面交界處",
		...
		text3: "從建築、道路尺度再拉遠，大範圍的土壤液化潛勢是否也會造成影響？",
		"captiontitle4-1": "位置比值計算方式",
		"captiontext4-1": "將案件距路心距離除以一半路寬，計算位置比值。",
		"captiontitle4-2": "位置比值折線圖",
		"captiontext4-2": "此圖待重新計算",
	},
	"space-3": {
		title: "土壤液化潛勢",
		...
		"captiontitle4-1": "土壤液化潛勢範圍圖",
		"captiontext4-1": "顏色越深代表土壤液化潛勢越高，共分三級。",
		"captiontitle4-2": "計算數值",
		"captiontext4-2": "此圖待重新計算",
	},
	"space-4": {
		title: "臨河區域",
		...
		"captiontitle4-1": "臨河500m範圍與標記掏空案件分布",
		"captiontext4-1": "臨河範圍定義參考：劉格非、黃南輝、楊代強，《受潮汐影響之地下水資料分析》，1994。",
		"captiontitle4-2": "臨河500m範圍內案件占比",
		"captiontext4-2": "此圖待重新計算",
	},
	"space-5": {
		title: "水系搶修案件",
		...
		text2: "結果顯示，人工標記的掏空案件中，有5.6%受到水系搶修影響。雖然這並非主要原因，但相較於建案占比1%已屬相對較高。因此，實務上應將其納入預防考量。",
		text3: "有管線才需要維修，那麼管線分布越密集或越老舊，是否也越可能造成掏空？",
		"captiontitle4-1": "水系搶修影響分析方式",
		"captiontext4-1": "水系搶修案件位於道路維修案件半徑10米內，且水系搶修發生於道路案件申報的前30日或後5日，可將相關案件定義為受水系搶修影響。",
		"captiontitle4-2": "水系搶修案件占比",
		"captiontext4-2": "此圖待重新計算",
	},
	"space-6": {
		title: "水系管線分布",
		...
		text3: "此外，標記掏空案件中，管線設置年份多為1993年，相比非標記掏空案件的2000年更為老舊。因此，未來在這些區域應多加留意並加強巡檢。",
		text4: "除了管線，若從土壤承受壓力的角度思考，建築物的容積或樓層數量是否與掏空存在某種潛在關係？",
		"captiontitle5-1": "水系搶修影響分析方式",
		"captiontext5-1": "水系搶修案件位於道路維修案件半徑10米內，且水系搶修發生於道路案件申報的前30日或後5日，可將相關案件定義為受水系搶修影響。",
		"captiontitle5-2": "水系搶修案件占比",
		"captiontext5-2": "此圖待重新計算",
	},
	"space-7": {
		title: "建築面積與樓層數",
		...
		text3: "新工處推測，這可能與城市發展有關，舊城區由於較早發展，因此管線等基礎設施配置流量較低，面臨老舊和需更新的需求自然較多。",
		text4: "地底下除了建築物和管線，日常搭乘的捷運、火車甚至高鐵，這些大眾運輸設施也在地底下佔據了非常大量的空間。道路掏空是否與其有關？",
	},
	"space-8": {
		title: "地下構造物",
		...
		text3: "結果顯示，標記掏空案件極少發生於有地下構造物的路面上。高鐵和臺鐵路線未涵蓋任何掏空案件，而捷運路網較密集，但也僅包含7件。由此推定與地下構造物無關。",
