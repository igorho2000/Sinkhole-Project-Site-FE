export const ch = {
	...
	"overview-1": {
		...
		captiontext5:"損壞說明或派工說明包含「掏空、塌陷、坍塌、交維、交圍、下陷」",
	},
	"overview-2": {
		title: "潛在成因怎麼看",
	...
	"overview-3": {
		...
		subtitle: "判定重要成因標準？",
		text1: "時間分析若成因重要性前五名且相關性接近中度相關，則判定為重要成因。若相關性低則初步排除重要成因。",
		text2: "時間分析若成因重要性前五名且相關性接近中度相關，則判定為重要成因。若相關性低則初步排除重要成因。",
		text4: "空間分析以「發生過的道路維修案件」為基礎，分析報案地點具備哪些特質較有機率屬於掏空案件。若掏空案件影響占比大於非掏空案件則認定為重要成因。相關重要成因提供權責機關作為預防或後續改善參考。",
		"captiontitle5-1": "以案件點位進行分析",
		"captiontext5-1": "以全市道路維修案件為主，非全部路面範圍，避免無案件發生點位涵蓋面積過大影響分析結果。",
		"captiontitle5-2": "空間重要成因認定方式",
		"captiontext5-2": "若標記掏空案件該成因影響占比大於非掏空案件，則認定為重要成因；反之則非重要成因。",
	},
	"time-1": {
		title: "颱風",
	...
	"space-2": {
		...
		text3: "除建築、道路外，大範圍地層性質相關的土壤液化潛勢，是否也屬重要成因？",
