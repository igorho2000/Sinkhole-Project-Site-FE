...
<template>
	<div class="homepage">
		<div class="homepage-sinkhole">
			<div class="homepage-sinkhole-pulser"></div>
			<div
		...
		<Transition name="page">
			<div class="homepage-main" v-if="page === 1">
		...
		>
		<Transition name="page">
			<div class="homepage-summary" v-if="page === 2">
				<p>{{ t("home.summary1") }}</p>
				<p>{{ t("home.summary2") }}</p>
			</div></Transition
		>
		<Transition name="page">
			<div class="homepage-image" v-if="page === 3">
		...
		>
		<Transition name="page">
			<div class="homepage-image" v-if="page === 4">
